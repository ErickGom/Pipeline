...
<body>
    ...
    if (isset($_REQUEST['guardar'])) {
        ...
        if (isset($_POST['matricula'])) {
            ...
            $query = "UPDATE tbl_user SET matriculauser='".$matricula."', tx_nombreuser='".$nombre."', tx_appaterno='".$apellidop."', tx_apmaterno='".$apellidom."', tx_username='".$usuario."', tx_password='".$contraseña."', carrera_idcarrera='".$carrera."', cuatrimestre_idcuatrimestre='".$cuatrimestre."', grupo_idgrupo='".$grupo."', dt_registro=NOW()
            WHERE (idtbl_user=$id)";
