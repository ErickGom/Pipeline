...
$db = new Database();
$consulta= $db->connect()->prepare('SELECT * FROM tutor INNER JOIN carrera INNER JOIN cuatrimestre INNER JOIN grupo WHERE tutor.carrera_idcarrera = carrera.idcarrera AND tutor.cuatrimestre_idcuatrimestre = cuatrimestre.idcuatrimestre AND tutor.grupo_idgrupo = grupo.idgrupo');
...
if(isset($row)){
  ...
  <table class="tabla_datos">
    ...
    <?php 
    $sql="SELECT * FROM tutor INNER JOIN carrera INNER JOIN cuatrimestre INNER JOIN grupo WHERE tutor.carrera_idcarrera = carrera.idcarrera AND tutor.cuatrimestre_idcuatrimestre = cuatrimestre.idcuatrimestre AND tutor.grupo_idgrupo = grupo.idgrupo AND ctg_tipousuario_idctg_tipousuario=2 ORDER BY tx_appaterno ASC";
    ...
    <tr>
        ...
        <td>
            <a class="btn-warning" href="actions/deleteT.php?id=<?php print $mostrar['id_cedula'] ?>">Eliminar</a>
             | 
            <a class="btn-mod" href="actions/modificT.php?id=<?php print $mostrar['id_cedula'] ?>">Modificar</a></td>
    </tr>
  <?php 
  }
   ?>
