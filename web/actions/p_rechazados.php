...
$db = new Database();
$consulta= $db->connect()->prepare('SELECT * FROM tbl_user INNER JOIN solicitudpermiso_tbl_user INNER JOIN solicitudpermiso INNER JOIN status_permiso WHERE solicitudpermiso_tbl_user.tbl_user_idtbl_user = tbl_user.idtbl_user AND solicitudpermiso_tbl_user.solicitudpermiso_idsolicitudpermiso = solicitudpermiso.idsolicitudpermiso AND solicitudpermiso_tbl_user.status_permiso_idstatus_permiso = status_permiso.idstatus_permiso AND idstatus_permiso=3 ORDER BY tx_appaterno ASC');
